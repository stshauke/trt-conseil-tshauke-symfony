...
class UtilisateurCandidatType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('plainPassword', PasswordType::class, [
            ...
            ->add('roles', ChoiceType::class, [
                ...
                'data' => ['ROLE_CANDIDAT'], //Définir la valeur par défaut
            ])
            ...
            ->add('cv', FileType::class, [
                'label'=>false,
                'mapped' => false, // Indique que ce champ ne sera pas mappé à une propriété de l'entité Utilisateur
