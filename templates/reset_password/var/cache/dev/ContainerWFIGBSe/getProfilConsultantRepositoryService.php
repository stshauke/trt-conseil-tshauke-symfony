 ...
 */
class getProfilConsultantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilConsultantRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilConsultantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilConsultantRepository.php';

        return $container->privates['App\\Repository\\ProfilConsultantRepository'] = new \App\Repository\ProfilConsultantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
