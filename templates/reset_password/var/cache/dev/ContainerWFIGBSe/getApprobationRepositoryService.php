 ...
 */
class getApprobationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ApprobationRepository' shared autowired service.
     *
     * @return \App\Repository\ApprobationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApprobationRepository.php';

        return $container->privates['App\\Repository\\ApprobationRepository'] = new \App\Repository\ApprobationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
