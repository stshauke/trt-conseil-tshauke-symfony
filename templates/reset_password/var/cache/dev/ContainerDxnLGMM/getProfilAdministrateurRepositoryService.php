 ...
 */
class getProfilAdministrateurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilAdministrateurRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilAdministrateurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilAdministrateurRepository.php';

        return $container->privates['App\\Repository\\ProfilAdministrateurRepository'] = new \App\Repository\ProfilAdministrateurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
