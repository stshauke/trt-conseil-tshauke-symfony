 ...
 */
class getProfilRecruteurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilRecruteurRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilRecruteurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilRecruteurRepository.php';

        return $container->privates['App\\Repository\\ProfilRecruteurRepository'] = new \App\Repository\ProfilRecruteurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
