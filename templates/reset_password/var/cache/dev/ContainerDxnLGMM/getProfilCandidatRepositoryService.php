 ...
 */
class getProfilCandidatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilCandidatRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilCandidatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilCandidatRepository.php';

        return $container->privates['App\\Repository\\ProfilCandidatRepository'] = new \App\Repository\ProfilCandidatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
